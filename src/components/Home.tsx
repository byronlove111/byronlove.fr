        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4 pt-4">
            ...
            <p className="text-sm text-black leading-relaxed">
              ...
              <span className="text-gray-600">Co-Founder (2025–Present)</span> – Led a multidisciplinary team of 10 people to build a platform that unites all builders to shape the future of open-source. 500 sign up at launch, bringing together designers, ML engineers, backend and frontend developers
            </p>
            ...
            <p className="text-sm text-black leading-relaxed">
              ...
              <span className="text-gray-600">Founding Engineer (2024–2025)</span> – First founding engineer of the company. 0-to-1 journey with €1.5M raised, completely rebuilt and optimized the frontend with scalable architecture and comprehensive testing, implemented full-stack end-to-end features. Worked closely with users with strong product vision, developed marketing solutions that reached 10,000+ users
            </p>
